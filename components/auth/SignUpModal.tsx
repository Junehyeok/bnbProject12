...
const SignUpModal: React.FC<IProps> = ({ closeModal }) => {
    ...
    return (
      <Container onSubmit={onSubmitSignUp}>
        ...
        <div className="input-wrapper input-icon-wrapper">
          <Input
            placeholder="이메일 주소"
            type="email"
            icon={<MailIcon />}
        ...
        <div className="input-wrapper sign-up-password-input-wrappe">
          <Input
